...
- a dumb hack (and would you call it that publicly)?
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/HackedThermometer.jpeg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
