...
thumbnail: assets/img/DaVinciMashup.jpeg
---

I am a huge fan of product teams that build products via the combination of:

- a profound understanding of customer problems
- beautiful design
...
That realization has led many to settle into roles (and orgs) that reinforce the notion that these three disciplines are completely different lanes and that those in one need (or should) not endeavor to learn as much about the others as possible. Worse, those in a given lane often feel compelled to 'protect their turf' from the others with various 'not welcome here' behaviors.
...
<b>(Note the use of 'artfully' in the definition below)</b>

<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/DaVinciMashup.jpeg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
