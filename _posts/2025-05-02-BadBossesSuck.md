...
<b>Me (realizing that I was standing in the presence of greatness)</b>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/LedZeppelin.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
